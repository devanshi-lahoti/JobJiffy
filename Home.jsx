...
export default function Home() {
  ...
  const renderServiceCards = () => {
    if (!Array.isArray(serviceProviders)) {
      return <div className="error">Invalid data format received from server</div>;
    }
    ...
    return serviceProviders.map((provider) => (
      <div
        ...
        onClick={() => navigate(`/services/${provider.serviceType}`)}
      >
        <div className="service-content">
          <img 
            src={provider.image || '/default-service.png'} 
            alt={provider.serviceType}
            className="service-image"
          />
          <span className="service-text">{provider.serviceType}</span>
          <span className="service-rating">Rating: {provider.rating || 'N/A'}</span>
        </div>
      </div>
    ));
  };
    ...
    <div className="app dark-theme">
      <nav className="navbar">
        ...
        {isLoggedIn ? (
          ...
          <button className="login-btn" onClick={() => navigate('/login/user')}>
            Login
          </button>
        )}
      </nav>
      ...
      <div className="tabs">
        ...
        >
          <a href="#about" className="nav">WHY WE?</a>
        </div>
        <div
